...
var mariahCarey = checkSum(23);

console.log(mariahCarey);
...
function checkQuotient(){
  return num = product * quotient;
}

var checkQuot = checkQuotient();

console.log(checkQuot);
